...
$(function() {
	...
	var lottery = {
		...
		stop: function(index) {
			...
			// 	/*$(".ivfidresult>em").text(giftmessage);*/
             //    $(".cjjgxsvv>em").text(giftmessage);//奖品名称（弹窗的）
					...
					if (data.end == "success") {//登录后的操作
				         ...
				         switch (data.code) {//请求返回的抽中奖品字段
				             case 'G1':
				                 ...
				                 //setTimeout('$(".cjjgxsvv>p>img").attr("src","teimg/cjtstc8.png")',5000);
				                 break;
				             case 'G2':
				                 lottery.place = 7;
				                 $(".cjjgxsvv>p>img").attr("src","teimg/cjtstc7.png");
				                 //setTimeout('$(".cjjgxsvv>p>img").attr("src","teimg/cjtstc7.png")',5000);
				                 break;
				             case 'G3':
				                 lottery.place = 6;
				                $(".cjjgxsvv>p>img").attr("src","teimg/cjtstc6.png");
				                // setTimeout('$(".cjjgxsvv>p>img").attr("src","teimg/cjtstc6.png")',5000);
				                 break;
				             case 'G4':
				                 lottery.place = 5;
				                 $(".cjjgxsvv>p>img").attr("src","teimg/cjtstc3.png");
				                 //setTimeout('$(".cjjgxsvv>p>img").attr("src","teimg/cjtstc3.png")',5000);

				                 break;
				             case 'G5':
				                 lottery.place = 1;
				                 $(".cjjgxsvv>p>img").attr("src","teimg/cjtstc1.png");
				                 //setTimeout('$(".cjjgxsvv>p>img").attr("src","teimg/cjtstc1.png")',5000);
				                 break;
				             case 'G6':
				                 lottery.place = 4;
				                 $(".cjjgxsvv>p>img").attr("src","teimg/cjtstc4.png");
				                 //setTimeout('$(".cjjgxsvv>p>img").attr("src","teimg/cjtstc4.png")',5000);
				                 break;
				             case 'G7':
				                 lottery.place = 3;
				                 $(".cjjgxsvv>p>img").attr("src","teimg/cjtstc5.png");
				                 //setTimeout('$(".cjjgxsvv>p>img").attr("src","teimg/cjtstc5.png")',5000);
				                 break;
				             case 'G8':
				                 lottery.place = 2;
				                 $(".cjjgxsvv>p>img").attr("src","teimg/cjtstc2.png");
				                 //setTimeout('$(".cjjgxsvv>p>img").attr("src","teimg/cjtstc2.png")',5000);
				                 break;
				         }
    ...
    function roll() {
        ...
        if(lottery.times > lottery.cycle + 10 && lottery.prize == lottery.index) {
            ...
            // $(".cjjgtstcv").removeClass("curdis");//开始弹窗位置
	...
	$("#lottery .btn").on('click', function(event) {
        ...
        lottery.click = true;
            ...
            if (lastsynum < 1) {
                ...
                $(".ivfdchan>span i").html(parseInt(lastsynum) - 1);
                // console.
                // lottery.speed = 100;
                lottery.init('lottery');
                lottery.getLottery();
